...
#define CONTRAST_MAX 0x7F
#define CONTRAST_MIN 0x40
#define CONTRAST_DEF 0x60

#define COOLER_OFF_DELTA 2
...
typedef struct {
    ...
    int16   cooler_on_temperature;
    uint16   cooler_on_adc_data;
    uint16   cooler_off_adc_data;
