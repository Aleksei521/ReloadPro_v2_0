...
void IDAC_Low_Init(void)
{
    ...
    #if(IDAC_Low_MODE_SOURCE == IDAC_Low_IDAC_POLARITY)
        regVal  = IDAC_Low_CSD_TRIM1_REG & ~(IDAC_Low_CSD_IDAC_TRIM1_MASK);
        regVal |=  (IDAC_Low_SFLASH_TRIM1_REG & IDAC_Low_CSD_IDAC_TRIM1_MASK);
        IDAC_Low_CSD_TRIM1_REG = regVal;
    #else
        regVal  = IDAC_Low_CSD_TRIM2_REG & ~(IDAC_Low_CSD_IDAC_TRIM2_MASK);
        regVal |=  (IDAC_Low_SFLASH_TRIM2_REG & IDAC_Low_CSD_IDAC_TRIM2_MASK);
        IDAC_Low_CSD_TRIM2_REG = regVal;
    #endif /* (IDAC_Low_MODE_SOURCE == IDAC_Low_IDAC_POLARITY) */
