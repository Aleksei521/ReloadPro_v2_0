...
/*******************************************************************************
* Function Name: LCD_G77_1_I2C_I2C_ISR
****************************************************************************//**
*
*  Handles the Interrupt Service Routine for the SCB I2C mode.
*
*******************************************************************************/
CY_ISR(LCD_G77_1_I2C_I2C_ISR)
{
    uint32 diffCount;
    uint32 endTransfer;

#ifdef LCD_G77_1_I2C_I2C_ISR_ENTRY_CALLBACK
    LCD_G77_1_I2C_I2C_ISR_EntryCallback();
#endif /* LCD_G77_1_I2C_I2C_ISR_ENTRY_CALLBACK */

#if (LCD_G77_1_I2C_I2C_CUSTOM_ADDRESS_HANDLER_CONST)
    uint32 response;

    response = LCD_G77_1_I2C_I2C_ACK_ADDR;
    ...
    if(NULL != LCD_G77_1_I2C_customIntrHandler)
    {
        LCD_G77_1_I2C_customIntrHandler();
    }

    if(LCD_G77_1_I2C_CHECK_INTR_I2C_EC_MASKED(LCD_G77_1_I2C_INTR_I2C_EC_WAKE_UP))
    {
    ...
    */
    if(LCD_G77_1_I2C_CHECK_I2C_FSM_MASTER)
    {
        #if(LCD_G77_1_I2C_I2C_MASTER)
        {
            ...
            */
            if(LCD_G77_1_I2C_CHECK_INTR_MASTER_MASKED(LCD_G77_1_I2C_INTR_MASTER_I2C_BUS_ERROR))
            {
                LCD_G77_1_I2C_mstrStatus |= (uint16) (LCD_G77_1_I2C_I2C_MSTAT_ERR_XFER |
                                                         LCD_G77_1_I2C_I2C_MSTAT_ERR_BUS_ERROR);

                endTransfer = LCD_G77_1_I2C_I2C_CMPLT_ANY_TRANSFER;
            }
            ...
            */
            if(LCD_G77_1_I2C_CHECK_INTR_MASTER_MASKED(LCD_G77_1_I2C_INTR_MASTER_I2C_ARB_LOST))
            {
                LCD_G77_1_I2C_mstrStatus |= (uint16) (LCD_G77_1_I2C_I2C_MSTAT_ERR_XFER |
                                                         LCD_G77_1_I2C_I2C_MSTAT_ERR_ARB_LOST);

                endTransfer = LCD_G77_1_I2C_I2C_CMPLT_ANY_TRANSFER;
            }

            #if(LCD_G77_1_I2C_I2C_MULTI_MASTER_SLAVE)
            {
                /* I2C_MASTER_CMD_M_START_ON_IDLE:
                * MultiMaster-Slave does not generate start, because Slave was addressed.
                * Pass control to slave.
                */
                if(LCD_G77_1_I2C_CHECK_I2C_MASTER_CMD(LCD_G77_1_I2C_I2C_MASTER_CMD_M_START_ON_IDLE))
                {
                    LCD_G77_1_I2C_mstrStatus |= (uint16) (LCD_G77_1_I2C_I2C_MSTAT_ERR_XFER |
                                                             LCD_G77_1_I2C_I2C_MSTAT_ERR_ABORT_XFER);
            ...
            */
            if(0u != endTransfer)
            {
                ...
                LCD_G77_1_I2C_mstrStatus |= (uint16) LCD_G77_1_I2C_GET_I2C_MSTAT_CMPLT;
                ...
                #if(LCD_G77_1_I2C_I2C_MULTI_MASTER_SLAVE)
                {
                    if(LCD_G77_1_I2C_CHECK_I2C_FSM_ADDR)
                    {
                        ...
                        */
                        if(LCD_G77_1_I2C_CHECK_I2C_MASTER_CMD(LCD_G77_1_I2C_I2C_MASTER_CMD_M_START_ON_IDLE))
                        {
                            LCD_G77_1_I2C_I2C_MASTER_CLEAR_START;

                            endTransfer = LCD_G77_1_I2C_I2C_CMPLT_ANY_TRANSFER; /* Pass control to Slave */
                        }
                        ...
                        */
                        else if((!LCD_G77_1_I2C_CHECK_INTR_SLAVE_MASKED(LCD_G77_1_I2C_INTR_SLAVE_I2C_BUS_ERROR))
                               && LCD_G77_1_I2C_CHECK_INTR_MASTER_MASKED(LCD_G77_1_I2C_INTR_MASTER_I2C_ARB_LOST))
                        {
                            endTransfer = LCD_G77_1_I2C_I2C_CMPLT_ANY_TRANSFER; /* Pass control to Slave */
                        }
                        else
                        ...
                        {
                            LCD_G77_1_I2C_CLEAR_TX_FIFO; /* Shifter keeps address, clear it */

                            LCD_G77_1_I2C_DISABLE_MASTER_AUTO_DATA_ACK; /* In case of reading disable autoACK */
                        ...
                        else
                        {
                            ...
                            LCD_G77_1_I2C_state = LCD_G77_1_I2C_I2C_FSM_EXIT_IDLE;
                        }
                    }
                    else
                    {
    ...
    else /* (LCD_G77_1_I2C_CHECK_I2C_FSM_SLAVE) */
    {
        #if(LCD_G77_1_I2C_I2C_SLAVE)
        {
            /* INTR_SLAVE_I2C_BUS_ERROR or LCD_G77_1_I2C_INTR_SLAVE_I2C_ARB_LOST:
            * A Misplaced Start or Stop condition occurred on the bus: set a flag
            * to notify an error condition.
            */
            if(LCD_G77_1_I2C_CHECK_INTR_SLAVE_MASKED(LCD_G77_1_I2C_INTR_SLAVE_I2C_BUS_ERROR |
                                                        LCD_G77_1_I2C_INTR_SLAVE_I2C_ARB_LOST))
            {
                if(LCD_G77_1_I2C_CHECK_I2C_FSM_RD)
                {
                    /* TX direction: master reads from slave */
                    LCD_G77_1_I2C_slStatus &= (uint8) ~LCD_G77_1_I2C_I2C_SSTAT_RD_BUSY;
                    LCD_G77_1_I2C_slStatus |= (uint8) (LCD_G77_1_I2C_I2C_SSTAT_RD_ERR |
                                                          LCD_G77_1_I2C_I2C_SSTAT_RD_CMPLT);
                }
                else
                {
                    /* RX direction: master writes into slave */
                    LCD_G77_1_I2C_slStatus &= (uint8) ~LCD_G77_1_I2C_I2C_SSTAT_WR_BUSY;
                    LCD_G77_1_I2C_slStatus |= (uint8) (LCD_G77_1_I2C_I2C_SSTAT_WR_ERR |
                                                          LCD_G77_1_I2C_I2C_SSTAT_WR_CMPLT);
                }
    ...
    */
    ...
    if(LCD_G77_1_I2C_CHECK_I2C_FSM_MASTER)
    {
        #if(LCD_G77_1_I2C_I2C_MASTER)
        {
            ...
            */
            if(LCD_G77_1_I2C_CHECK_INTR_MASTER_MASKED(LCD_G77_1_I2C_INTR_MASTER_I2C_STOP))
            {
                LCD_G77_1_I2C_ClearMasterInterruptSource(LCD_G77_1_I2C_INTR_MASTER_I2C_STOP);
            ...
            {
                if(LCD_G77_1_I2C_CHECK_I2C_FSM_ADDR) /* Address stage */
                {
                    /* INTR_MASTER_I2C_NACK:
                    * The master sent an address but it was NACKed by the slave. Complete transaction.
                    */
                    if(LCD_G77_1_I2C_CHECK_INTR_MASTER_MASKED(LCD_G77_1_I2C_INTR_MASTER_I2C_NACK))
                    {
                        LCD_G77_1_I2C_ClearMasterInterruptSource(LCD_G77_1_I2C_INTR_MASTER_I2C_NACK);

                        LCD_G77_1_I2C_mstrStatus |= (uint16) (LCD_G77_1_I2C_I2C_MSTAT_ERR_XFER |
                                                                 LCD_G77_1_I2C_I2C_MSTAT_ERR_ADDR_NAK);
                    ...
                    */
                    ...
                    {
                        if(LCD_G77_1_I2C_CHECK_I2C_FSM_RD) /* Reading */
                        {
                        ...
                        else /* Writing */
                        {
                            ...
                            if(0u != LCD_G77_1_I2C_mstrWrBufSize)
                            {
                                /* Enable INTR.TX_EMPTY if there is data to transmit */
                                LCD_G77_1_I2C_SetTxInterruptMode(LCD_G77_1_I2C_INTR_TX_EMPTY);
                            }
                        }
                    }
                }

                if(LCD_G77_1_I2C_CHECK_I2C_FSM_DATA) /* Data phase */
                {
                    if(LCD_G77_1_I2C_CHECK_I2C_FSM_RD) /* Reading */
                    {
                        /* INTR_RX_FULL:
                        ...
                        */
                        if(LCD_G77_1_I2C_CHECK_INTR_RX_MASKED(LCD_G77_1_I2C_INTR_RX_FULL))
                        {
                            /* Calculate difference */
                            diffCount =  LCD_G77_1_I2C_mstrRdBufSize -
                                        (LCD_G77_1_I2C_mstrRdBufIndex + LCD_G77_1_I2C_GET_RX_FIFO_ENTRIES);

                            /* Proceed transaction or end it when RX FIFO becomes FULL again */
                            if(diffCount > LCD_G77_1_I2C_I2C_FIFO_SIZE)
                            {
                                diffCount = LCD_G77_1_I2C_I2C_FIFO_SIZE;
                            }
                            else
                            {
                                if(0u == diffCount)
                                {
                                    LCD_G77_1_I2C_DISABLE_MASTER_AUTO_DATA_ACK;
                            ...
                            {
                                LCD_G77_1_I2C_mstrRdBufPtr[LCD_G77_1_I2C_mstrRdBufIndex] = (uint8)
                                                                                        LCD_G77_1_I2C_RX_FIFO_RD_REG;
                                LCD_G77_1_I2C_mstrRdBufIndex++;
                            }
                        }
                        /* INTR_RX_NOT_EMPTY:
                        ...
                        */
                        else if(LCD_G77_1_I2C_CHECK_INTR_RX_MASKED(LCD_G77_1_I2C_INTR_RX_NOT_EMPTY))
                        {
                            /* Put data in component buffer */
                            LCD_G77_1_I2C_mstrRdBufPtr[LCD_G77_1_I2C_mstrRdBufIndex] = (uint8) LCD_G77_1_I2C_RX_FIFO_RD_REG;
                            LCD_G77_1_I2C_mstrRdBufIndex++;

                            if(LCD_G77_1_I2C_mstrRdBufIndex < LCD_G77_1_I2C_mstrRdBufSize)
                            {
                    ...
                    else /* Writing */
                    {
                        ...
                        */
                        if(LCD_G77_1_I2C_CHECK_INTR_MASTER_MASKED(LCD_G77_1_I2C_INTR_MASTER_I2C_NACK))
                        {
                            ...
                            LCD_G77_1_I2C_mstrWrBufIndexTmp -= (LCD_G77_1_I2C_GET_TX_FIFO_ENTRIES +
                                                                   LCD_G77_1_I2C_GET_TX_FIFO_SR_VALID);

                            /* Update number of transferred bytes */
                            LCD_G77_1_I2C_mstrWrBufIndex = LCD_G77_1_I2C_mstrWrBufIndexTmp;

                            LCD_G77_1_I2C_mstrStatus |= (uint16) (LCD_G77_1_I2C_I2C_MSTAT_ERR_XFER |
                                                                     LCD_G77_1_I2C_I2C_MSTAT_ERR_SHORT_XFER);

                            LCD_G77_1_I2C_CLEAR_TX_FIFO;
                        ...
                        */
                        else if(LCD_G77_1_I2C_CHECK_INTR_TX_MASKED(LCD_G77_1_I2C_INTR_TX_EMPTY))
                        {
                            while(LCD_G77_1_I2C_I2C_FIFO_SIZE != LCD_G77_1_I2C_GET_TX_FIFO_ENTRIES)
                            {
                                ...
                                */
                                if(LCD_G77_1_I2C_mstrWrBufIndexTmp < LCD_G77_1_I2C_mstrWrBufSize)
                                {
                                    ...
                                    */
                                    if(LCD_G77_1_I2C_mstrWrBufIndexTmp == (LCD_G77_1_I2C_mstrWrBufSize - 1u))
                                    {
                                    ...
                                    LCD_G77_1_I2C_TX_FIFO_WR_REG = (uint32) LCD_G77_1_I2C_mstrWrBufPtr[LCD_G77_1_I2C_mstrWrBufIndexTmp];
                                    LCD_G77_1_I2C_mstrWrBufIndexTmp++;
                                }
                                else
                                {
                        ...
                        #else
                            LCD_G77_1_I2C_ClearTxInterruptSource(LCD_G77_1_I2C_INTR_TX_EMPTY);
                        #endif /* (LCD_G77_1_I2C_CY_SCBIP_V0) */
                        }
                        /* INTR_TX_UNDERFLOW:
                        ...
                        */
                        else if(LCD_G77_1_I2C_CHECK_INTR_TX_MASKED(LCD_G77_1_I2C_INTR_TX_UNDERFLOW))
                        {
                            /* Update number of transferred bytes */
                            LCD_G77_1_I2C_mstrWrBufIndex = LCD_G77_1_I2C_mstrWrBufIndexTmp;
                ...
                if(0u != endTransfer) /* Complete transfer */
                {
                    ...
                    if(LCD_G77_1_I2C_CHECK_I2C_MODE_NO_STOP(LCD_G77_1_I2C_mstrControl))
                    {
                        ...
                        LCD_G77_1_I2C_mstrStatus |= (uint16) (LCD_G77_1_I2C_I2C_MSTAT_XFER_HALT |
                                                                 LCD_G77_1_I2C_GET_I2C_MSTAT_CMPLT);

                        LCD_G77_1_I2C_state = LCD_G77_1_I2C_I2C_FSM_MSTR_HALT;
                    }
                    else
                    {
        ...
        } /* (LCD_G77_1_I2C_I2C_MASTER) */
        #endif

    } /* (LCD_G77_1_I2C_CHECK_I2C_FSM_MASTER) */


    /* FSM Slave */
    else if(LCD_G77_1_I2C_CHECK_I2C_FSM_SLAVE)
    {
        #if(LCD_G77_1_I2C_I2C_SLAVE)
        {
            /* INTR_SLAVE_NACK:
            ...
            */
            if(LCD_G77_1_I2C_CHECK_INTR_SLAVE_MASKED(LCD_G77_1_I2C_INTR_SLAVE_I2C_NACK))
            {
                LCD_G77_1_I2C_ClearSlaveInterruptSource(LCD_G77_1_I2C_INTR_SLAVE_I2C_NACK);

                /* All entries that remain in TX FIFO are: FIFO Size + 1 (SHIFTER) */
                diffCount = (LCD_G77_1_I2C_GET_TX_FIFO_ENTRIES + LCD_G77_1_I2C_GET_TX_FIFO_SR_VALID);

                if(LCD_G77_1_I2C_slOverFlowCount > diffCount) /* Overflow */
                {
                    LCD_G77_1_I2C_slStatus |= (uint8) LCD_G77_1_I2C_I2C_SSTAT_RD_OVFL;
                }
                else /* No Overflow */
                {
                    /* Roll-back temporary index */
                    LCD_G77_1_I2C_slRdBufIndexTmp -= (diffCount - LCD_G77_1_I2C_slOverFlowCount);
                }

                /* Update slave of transferred bytes */
                LCD_G77_1_I2C_slRdBufIndex = LCD_G77_1_I2C_slRdBufIndexTmp;
                ...
                LCD_G77_1_I2C_slStatus &= (uint8) ~LCD_G77_1_I2C_I2C_SSTAT_RD_BUSY;
                LCD_G77_1_I2C_slStatus |= (uint8)  LCD_G77_1_I2C_I2C_SSTAT_RD_CMPLT;
                LCD_G77_1_I2C_state     =  LCD_G77_1_I2C_I2C_FSM_IDLE;
                
            #ifdef LCD_G77_1_I2C_I2C_SLAVE_CMPLT_CALLBACK
                /* Read complete */
                LCD_G77_1_I2C_I2C_SlaveCompleteCallback();
            #endif /* LCD_G77_1_I2C_I2C_SLAVE_CMPLT_CALLBACK */
            }
            ...
            */
            if(LCD_G77_1_I2C_CHECK_INTR_SLAVE_MASKED(LCD_G77_1_I2C_INTR_SLAVE_I2C_WRITE_STOP))
            {
                LCD_G77_1_I2C_ClearSlaveInterruptSource(LCD_G77_1_I2C_INTR_SLAVE_I2C_WRITE_STOP);
                ...
                * I2C_ADDR_MATCH.
                */
                if (0u != (LCD_G77_1_I2C_I2C_CTRL_REG & LCD_G77_1_I2C_I2C_CTRL_S_READY_DATA_ACK))
                {
                    while(0u != LCD_G77_1_I2C_GET_RX_FIFO_ENTRIES)
                    {
                        #if(LCD_G77_1_I2C_CHECK_I2C_ACCEPT_ADDRESS)
                        {
                            if((1u == LCD_G77_1_I2C_GET_RX_FIFO_ENTRIES) &&
                               (LCD_G77_1_I2C_CHECK_INTR_SLAVE_MASKED(LCD_G77_1_I2C_INTR_SLAVE_I2C_ADDR_MATCH)))
                            {
                        ...
                        /* Put data in component buffer */
                        LCD_G77_1_I2C_slWrBufPtr[LCD_G77_1_I2C_slWrBufIndex] = (uint8) LCD_G77_1_I2C_RX_FIFO_RD_REG;
                        LCD_G77_1_I2C_slWrBufIndex++;
                    }

                    LCD_G77_1_I2C_DISABLE_SLAVE_AUTO_DATA;
                }

                if(LCD_G77_1_I2C_CHECK_INTR_RX(LCD_G77_1_I2C_INTR_RX_OVERFLOW))
                {
                    LCD_G77_1_I2C_slStatus |= (uint8) LCD_G77_1_I2C_I2C_SSTAT_WR_OVFL;
                }
                ...
                LCD_G77_1_I2C_slStatus &= (uint8) ~LCD_G77_1_I2C_I2C_SSTAT_WR_BUSY;
                LCD_G77_1_I2C_slStatus |= (uint8)  LCD_G77_1_I2C_I2C_SSTAT_WR_CMPLT;
                LCD_G77_1_I2C_state     =  LCD_G77_1_I2C_I2C_FSM_IDLE;
            ...
            */
        #if (LCD_G77_1_I2C_I2C_CUSTOM_ADDRESS_HANDLER_CONST)
            if (LCD_G77_1_I2C_CHECK_INTR_SLAVE_MASKED(LCD_G77_1_I2C_INTR_SLAVE_I2C_ADDR_MATCH |
        ...
        #endif /* (LCD_G77_1_I2C_I2C_CUSTOM_ADDRESS_HANDLER_CONST) */
            {
                ...
                LCD_G77_1_I2C_ClearI2CExtClkInterruptSource(LCD_G77_1_I2C_INTR_I2C_EC_WAKE_UP);

                #if (LCD_G77_1_I2C_I2C_CUSTOM_ADDRESS_HANDLER)
                {
                    if (NULL != LCD_G77_1_I2C_customAddressHandler)
                    {
                        /* Call custom address handler */
                        response = LCD_G77_1_I2C_customAddressHandler();
                    }
                    else
                    {
                        /* Read address from the RX FIFO. If there is no address underflow triggers but
                        * component does not use that source. */
                        (void) LCD_G77_1_I2C_RX_FIFO_RD_REG;
                        response = LCD_G77_1_I2C_I2C_ACK_ADDR;
                    }
            ...
            #if (LCD_G77_1_I2C_I2C_CUSTOM_ADDRESS_HANDLER_CONST)
                if (response == LCD_G77_1_I2C_I2C_NAK_ADDR)
                {
                #if (!LCD_G77_1_I2C_CY_SCBIP_V0)
                    /* Disable write stop interrupt source as it triggers after address was NACKed. Ticket ID#156094 */
                    LCD_G77_1_I2C_DISABLE_INTR_SLAVE(LCD_G77_1_I2C_INTR_SLAVE_I2C_WRITE_STOP);
                #endif /* (!LCD_G77_1_I2C_CY_SCBIP_V0) */
                    ...
                    LCD_G77_1_I2C_I2C_SLAVE_GENERATE_NACK;
                }
                else
            #endif /* (LCD_G77_1_I2C_I2C_CUSTOM_ADDRESS_HANDLER_CONST) */
                {
                    if(LCD_G77_1_I2C_CHECK_I2C_STATUS(LCD_G77_1_I2C_I2C_STATUS_S_READ))
                    /* TX direction: master reads from slave */
                    {
                        LCD_G77_1_I2C_SetTxInterruptMode(LCD_G77_1_I2C_INTR_TX_EMPTY);

                        /* Set temporary index to address buffer clear from API */
                        LCD_G77_1_I2C_slRdBufIndexTmp = LCD_G77_1_I2C_slRdBufIndex;

                        /* Start master reading */
                        LCD_G77_1_I2C_slStatus |= (uint8) LCD_G77_1_I2C_I2C_SSTAT_RD_BUSY;
                        LCD_G77_1_I2C_state     = LCD_G77_1_I2C_I2C_FSM_SL_RD;
                    }
                    else
                    /* RX direction: master writes into slave */
                    {
                        /* Calculate available buffer size */
                        diffCount = (LCD_G77_1_I2C_slWrBufSize - LCD_G77_1_I2C_slWrBufIndex);
                        ...
                        /* Receive data: into RX FIFO */
                        {
                            if(diffCount == LCD_G77_1_I2C_I2C_FIFO_SIZE)
                            {
                                ...
                                LCD_G77_1_I2C_ENABLE_SLAVE_AUTO_DATA;
                            }
                            else
                            {
                                /* Stretch clock when RX FIFO becomes FULL */
                                LCD_G77_1_I2C_ENABLE_SLAVE_AUTO_DATA_ACK;
                        ...
                        /* Start master reading */
                        LCD_G77_1_I2C_slStatus |= (uint8) LCD_G77_1_I2C_I2C_SSTAT_WR_BUSY;
                        LCD_G77_1_I2C_state     = LCD_G77_1_I2C_I2C_FSM_SL_WR;
                    }
                    ...
                    LCD_G77_1_I2C_ENABLE_INTR_SLAVE(LCD_G77_1_I2C_INTR_SLAVE_I2C_WRITE_STOP);
                #endif /* (!LCD_G77_1_I2C_CY_SCBIP_V0) */

                    /* ACK the address byte */
                    LCD_G77_1_I2C_I2C_SLAVE_GENERATE_ACK;
                }
            }
            ...
            */
            if(LCD_G77_1_I2C_CHECK_INTR_RX_MASKED(LCD_G77_1_I2C_INTR_RX_FULL))
            {
                ...
                diffCount =  LCD_G77_1_I2C_slWrBufSize -
                            (LCD_G77_1_I2C_slWrBufIndex + LCD_G77_1_I2C_I2C_FIFO_SIZE);

                if(diffCount > LCD_G77_1_I2C_I2C_FIFO_SIZE) /* Proceed transaction */
                {
                    diffCount   = LCD_G77_1_I2C_I2C_FIFO_SIZE;
                    endTransfer = 0u;  /* Continue active transfer */
                }
                ...
                {
                    LCD_G77_1_I2C_ENABLE_SLAVE_AUTO_DATA_NACK;
                ...
                LCD_G77_1_I2C_ClearRxInterruptSource(LCD_G77_1_I2C_INTR_RX_FULL);
            }
            ...
            */
            ...
            {
                diffCount = LCD_G77_1_I2C_RX_FIFO_RD_REG;

                if(LCD_G77_1_I2C_slWrBufIndex < LCD_G77_1_I2C_slWrBufSize)
                {
                    LCD_G77_1_I2C_I2C_SLAVE_GENERATE_ACK;

                    /* Put data into component buffer */
                    LCD_G77_1_I2C_slWrBufPtr[LCD_G77_1_I2C_slWrBufIndex] = (uint8) diffCount;
                    LCD_G77_1_I2C_slWrBufIndex++;
                }
                ...
                LCD_G77_1_I2C_ClearRxInterruptSource(LCD_G77_1_I2C_INTR_RX_NOT_EMPTY);
            }
            else
            {
                /* Does nothing */
            ...
            */
            if(LCD_G77_1_I2C_CHECK_INTR_TX_MASKED(LCD_G77_1_I2C_INTR_TX_EMPTY))
            {
                while(LCD_G77_1_I2C_I2C_FIFO_SIZE != LCD_G77_1_I2C_GET_TX_FIFO_ENTRIES)
                {
                    ...
                    */
                    if(LCD_G77_1_I2C_slRdBufIndexTmp < LCD_G77_1_I2C_slRdBufSize)
                    /* Data from buffer */
                    {
                        LCD_G77_1_I2C_TX_FIFO_WR_REG = (uint32) LCD_G77_1_I2C_slRdBufPtr[LCD_G77_1_I2C_slRdBufIndexTmp];
                        LCD_G77_1_I2C_slRdBufIndexTmp++;
                    }
                    else
                    /* Probably Overflow */
                    {
                        LCD_G77_1_I2C_TX_FIFO_WR_REG = LCD_G77_1_I2C_I2C_SLAVE_OVFL_RETURN;

                        if(LCD_G77_1_I2C_slOverFlowCount <= LCD_G77_1_I2C_I2C_TX_OVERFLOW_COUNT)
                        {
                            /* Get counter in range of overflow. */
                            LCD_G77_1_I2C_slOverFlowCount++;
                        }
                    }
                }
...
#ifdef LCD_G77_1_I2C_I2C_ISR_EXIT_CALLBACK
    LCD_G77_1_I2C_I2C_ISR_ExitCallback();
#endif /* LCD_G77_1_I2C_I2C_ISR_EXIT_CALLBACK */
