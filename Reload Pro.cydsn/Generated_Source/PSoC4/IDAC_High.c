...
void IDAC_High_Init(void)
{
    ...
    #if(IDAC_High_MODE_SOURCE == IDAC_High_IDAC_POLARITY)
        regVal  = IDAC_High_CSD_TRIM1_REG & ~(IDAC_High_CSD_IDAC_TRIM1_MASK);
        regVal |=  (IDAC_High_SFLASH_TRIM1_REG & IDAC_High_CSD_IDAC_TRIM1_MASK);
        IDAC_High_CSD_TRIM1_REG = regVal;
    #else
        regVal  = IDAC_High_CSD_TRIM2_REG & ~(IDAC_High_CSD_IDAC_TRIM2_MASK);
        regVal |=  (IDAC_High_SFLASH_TRIM2_REG & IDAC_High_CSD_IDAC_TRIM2_MASK);
        IDAC_High_CSD_TRIM2_REG = regVal;
    #endif /* (IDAC_High_MODE_SOURCE == IDAC_High_IDAC_POLARITY) */
